...
<head>
    ...
    <!-- taken from https://stackoverflow.com/a/47329754 -->
  ...
  <div class="navbar" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link active" href="https://ascroob-nwhite44-jdailly-se3309-ascroob.c9users.io/public/index.php#" >Home <span class="sr-only">(current)</span></a>
      <li class="nav-item dropdown" >
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="https://ascroob-nwhite44-jdailly-se3309-ascroob.c9users.io/public/functions/data.php#">Monthly Usage</a>
          <div class="dropdown-divider"></div>
